    ...
    def render(self):
        ...
        async def selectCallback(interaction):
            ...
            if self.lives <= 0: 
                ...
                self.message = await interaction.followup.send(embed = lost, view = discord.ui.View())
                ...
                await self.message.delete()
                self.message = await interaction.followup.send(embed = won, view = discord.ui.View())
