...
class chest_5(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Get Out of Jail Free. Hold on to this card until you are in jail.", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Repent", "Repent and be released from horny jail. Hold on to this card until you are in horny jail.", "assets/card.png")
