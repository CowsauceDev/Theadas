...
class chest_8(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Income tax refund. Collect $20", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Is it Really Fraud?", "You under-reported your income and got a refund! Collect $20.", "assets/card.png")
