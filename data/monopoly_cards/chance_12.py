...
class chance_12(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Speeding fine $15.", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("You Owe Us!", "You took a loan from a loan shark. Pay $15 in interest.", "assets/card.png")
