...
class chest_4(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "From sale of stock you get $50", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("You Sold Your Soul!", "It was only worth $50...", "assets/card.png")
