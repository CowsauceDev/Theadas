...
class chest_10(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Life insurance matures. Collect $100", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Worth it!", "You accept a job to burn down an orphanage for $100.", "assets/card.png")
