...
class chest_16(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "You inherit $100", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("One Man's Trash...", "You sell four aborted fetuses for $25 each. Collect $100", "assets/card.png")
