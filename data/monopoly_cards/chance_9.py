...
class chance_9(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Go Back 3 Spaces.", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Pull Yourself Together, Man!", "You died and spent days re-manifesting. Move back 3 spaces.", "assets/card.png")

    def on_draw(self, player, game):
        player.move(game, spaces = -3)