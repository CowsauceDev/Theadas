...
class chance_15(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Your building loan matures. Collect $150", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Payday!", "You worked the corner and earned $150.", "assets/card.png")
