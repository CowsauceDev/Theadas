...
class chest_11(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Pay hospital fees of $100", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("The Fuck is Insurance?", "You lost an eye during sex. The hospital bill was $100.", "assets/card.png")
