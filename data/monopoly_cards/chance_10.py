...
class chance_10(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Go to Jail. Go directly to Jail, do not pass Go, do not collect $200.", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Bonk!", "Go directly to horny jail. Do not pass Go. Do not collect $200.", "assets/card.png")
