...
class chest_13(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Receive $25 consultancy fee", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Work it, Girl!", "You pole dance at the club and make $25 in tips.", "assets/card.png")
