...
class chance_1(trust.Card):
    def __init__(self, variant: trust.Variant):
        match variant:
            case trust.Variant.BASE: super().__init__("", "Advance to The Boardwalk.", "assets/card.png")
            case trust.Variant.HELLOPOLY: super().__init__("Welcome to Heaven", "Advance to The Courtroom.", "assets/card.png")

    def on_draw(self, player, game):
        player.move(game, position = 39)